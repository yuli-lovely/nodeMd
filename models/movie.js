...
var MovieSchema=require('../schemas/movie');//h获取MovieSchema的模式
var Movie=mongoose.model('Movie',MovieSchema);//创建一个movie的模型，传入模型的名字以及模式
//将这个构造函数导出
...
//     return this.find({}).sort('meta.updateAt');//按照取出来的更新时间排序
//     exec(cb);//执行回调函数
//   }，
